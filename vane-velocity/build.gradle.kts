...
dependencies {
    ...
    implementation(group = "com.velocitypowered", name = "velocity-api", version = "4.0.0-SNAPSHOT")
    annotationProcessor(group = "com.velocitypowered", name = "velocity-api", version = "4.0.0-SNAPSHOT")
