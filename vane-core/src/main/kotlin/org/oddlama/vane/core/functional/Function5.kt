...
/** Erased five-argument function functor. */
fun interface Function5<T1, T2, T3, T4, T5, R> : ErasedFunctor, GenericsFinder {
    ...
    override fun invoke(args: List<Any?>): Any? {
        ...
        return apply(args[0] as T1?, args[1] as T2?, args[2] as T3?, args[3] as T4?, args[4] as T5?)
    }
}
