...
public class StorageUtil {
    ...
    public static boolean storageHasLocation(@NotNull PersistentDataContainer data, NamespacedKey key) {
        return data.has(subkey(key, "world"), PersistentDataType.STRING);
    }

    public static Location storageGetLocation(
        @NotNull PersistentDataContainer data,
        NamespacedKey key,
        Location def
    ) {
        try {
            final var worldId = data.get(subkey(key, "world"), PersistentDataType.STRING);
            ...
            final var world = Bukkit.getWorld(UUID.fromString(worldId));
            if (world == null) {
                return def;
            }
    ...
    public static void storageRemoveLocation(@NotNull PersistentDataContainer data, NamespacedKey key) {
    ...
    public static void storageSetLocation(
        @NotNull PersistentDataContainer data,
        NamespacedKey key,
